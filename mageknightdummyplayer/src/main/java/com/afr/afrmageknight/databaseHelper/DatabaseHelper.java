...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_2_CARTAS_ACCIONES_BASICAS_TABLE = "COLOR";
    public static final String COL_3_CARTAS_ACCIONES_BASICAS_TABLE = "DESCRIPCION_BASICA";
    public static final String COL_4_CARTAS_ACCIONES_BASICAS_TABLE = "DESCRIPCION_AVANZADA";
    public static final String COL_5_CARTAS_ACCIONES_BASICAS_TABLE = "HEROE";
    ...
    public static final String COL_2_CARTAS_ACCIONES_AVANZADAS_ESPECIALES_TABLE = "COLOR_PRIMARIO";
    public static final String COL_3_CARTAS_ACCIONES_AVANZADAS_ESPECIALES_TABLE = "COLOR_SECUNDARIO";
    public static final String COL_4_CARTAS_ACCIONES_AVANZADAS_ESPECIALES_TABLE = "DESCRIPCION_BASICA";
    public static final String COL_5_CARTAS_ACCIONES_AVANZADAS_ESPECIALES_TABLE = "DESCRIPCION_AVANZADA";
    ...
    public static final String COL_3_CARTAS_HECHIZOS_TABLE = "COLOR";
    public static final String COL_4_CARTAS_HECHIZOS_TABLE = "DESCRIPCION_BASICA";
    public static final String COL_5_CARTAS_HECHIZOS_TABLE = "DESCRIPCION_AVANZADA";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        Log.d("DATABASE", "TERCERO - ONCREATE - CARTAS_TABLE");
        ...
        strSQLCartasAccionesBasicasTable.append("CREATE TABLE ").append(CARTAS_ACCIONES_BASICAS_TABLE).append(" (")
                ...
                .append(COL_3_CARTAS_ACCIONES_BASICAS_TABLE).append(" TEXT NOT NULL,")
                .append(COL_4_CARTAS_ACCIONES_BASICAS_TABLE).append(" TEXT NOT NULL,")
                .append(COL_5_CARTAS_ACCIONES_BASICAS_TABLE).append(" TEXT NOT NULL")
                .append(")");

        Log.d("DATABASE", "CUARTO- ONCREATE - CARTAS_ACCIONES_BASICAS_TABLE");
        ...
        strSQLCartasAccionesAvanzadasEspecialesTable.append("CREATE TABLE ").append(CARTAS_ACCIONES_AVANZADAS_ESPECIALES_TABLE).append(" (")
                ...
                .append(COL_3_CARTAS_ACCIONES_AVANZADAS_ESPECIALES_TABLE).append(" TEXT NOT NULL,")
                .append(COL_4_CARTAS_ACCIONES_AVANZADAS_ESPECIALES_TABLE).append(" TEXT NOT NULL,")
                .append(COL_5_CARTAS_ACCIONES_AVANZADAS_ESPECIALES_TABLE).append(" TEXT NOT NULL")
                .append(")");

        Log.d("DATABASE", "SEXTO - ONCREATE - CARTAS_ACCIONES_AVANZADAS_ESPECIALES_TABLE");
        ...
        strSQLCartasHechizosTable.append("CREATE TABLE ").append(CARTAS_HECHIZOS_TABLE).append(" (")
                ...
                .append(COL_3_CARTAS_HECHIZOS_TABLE).append(" TEXT NOT NULL,")
                .append(COL_4_CARTAS_HECHIZOS_TABLE).append(" TEXT NOT NULL,")
                .append(COL_5_CARTAS_HECHIZOS_TABLE).append(" TEXT NOT NULL")
                .append(")");

        Log.d("DATABASE", "SEPTIMO - ONCREATE - CARTAS_HECHIZOS_TABLE");
        ...
        Log.d("DATABASE", "OCTAVO - ONCREATE - CARTAS_TACTICAS_TABLE");
        ...
        Log.d("DATABASE", "NOVENO - ONCREATE - FICHAS_HABILIDAD_TABLE");
    ...
    //Métodos para realizar operaciones CRUD (Create, Read, Update, Delete)
    public boolean insertDataCartaAccionBasica(int numero, Cristal color, String descripcionBasica, String descripcionAvanzada, Heroe heroe){
        ...
        contentValues.put(COL_2_CARTAS_ACCIONES_BASICAS_TABLE, color.toString());
        contentValues.put(COL_3_CARTAS_ACCIONES_BASICAS_TABLE, descripcionBasica);
        contentValues.put(COL_4_CARTAS_ACCIONES_BASICAS_TABLE, descripcionAvanzada);
        contentValues.put(COL_5_CARTAS_ACCIONES_BASICAS_TABLE, heroe.getNombre());
    ...
    //Métodos para realizar operaciones CRUD (Create, Read, Update, Delete)
    public boolean insertDataCartaAccionAvanzada(int numero, Cristal color, String descripcionBasica, String descripcionAvanzada){
    ...
    //Métodos para realizar operaciones CRUD (Create, Read, Update, Delete)
    public boolean insertDataCartaAccionAvanzadaEspecial(int numero, Cristal colorPrimario, Cristal colorSecundario, String descripcionBasica, String descripcionAvanzada){
        ...
        contentValues.put(COL_2_CARTAS_ACCIONES_AVANZADAS_ESPECIALES_TABLE, colorPrimario.toString());
        contentValues.put(COL_3_CARTAS_ACCIONES_AVANZADAS_ESPECIALES_TABLE, colorSecundario.toString());
        contentValues.put(COL_4_CARTAS_ACCIONES_AVANZADAS_ESPECIALES_TABLE, descripcionBasica);
        contentValues.put(COL_5_CARTAS_ACCIONES_AVANZADAS_ESPECIALES_TABLE, descripcionAvanzada);
    ...
    public boolean insertDataCartaHechizo(int numero, String nombreSecundario, Cristal color, String descripcionBasica, String descripcionAvanzada){
        ...
        contentValues.put(COL_3_CARTAS_HECHIZOS_TABLE, color.toString());
        contentValues.put(COL_4_CARTAS_HECHIZOS_TABLE, descripcionBasica);
        contentValues.put(COL_5_CARTAS_HECHIZOS_TABLE, descripcionAvanzada);
    ...
    public Carta create(Carta carta){
        ...
        if (carta.getClass() == CartaAccionBasica.class){
            CartaAccionBasica cartaAccionBasica = (CartaAccionBasica) carta;
            insertDataCartaAccionBasica(carta.getNumero(), cartaAccionBasica.getColor(), cartaAccionBasica.getDescripcionBasica(), cartaAccionBasica.getDescripcionAvanzada(), cartaAccionBasica.getHeroe());
        } else if(carta.getClass() == CartaAccionAvanzada.class) {
            CartaAccionAvanzada cartaAccionAvanzada = (CartaAccionAvanzada) carta;
            insertDataCartaAccionAvanzada(carta.getNumero(), cartaAccionAvanzada.getColor(), cartaAccionAvanzada.getDescripcionBasica(), cartaAccionAvanzada.getDescripcionAvanzada());
        } else if(carta.getClass() == CartaAccionAvanzadaEspecial.class) {
            CartaAccionAvanzadaEspecial cartaAccionAvanzadaEspecial = (CartaAccionAvanzadaEspecial) carta;
            insertDataCartaAccionAvanzadaEspecial(carta.getNumero(), cartaAccionAvanzadaEspecial.getColorPrimario(), cartaAccionAvanzadaEspecial.getColorSecundario(),cartaAccionAvanzadaEspecial.getDescripcionBasica(), cartaAccionAvanzadaEspecial.getDescripcionAvanzada());
    ...
    public void insertCards(){
        ...
        create(new CartaAccionBasica(1, "Versatilidad en la Batalla", Cristal.ROJO, "Ataque 2, Bloqueo 2 o Ataque a Distancia 1.", "Ataque 4, Bloqueo 4, Ataque de Fuego 3, Bloqueo de Fuego 3, Ataque a Distancia 3 o Ataque de Asedio 2.", arythea));
        create(new CartaAccionBasica(2, "Rabia", Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", arythea));
        create(new CartaAccionBasica(3, "Determinación", Cristal.AZUL, "Ataque o Bloqueo 2.", "Bloqueo 5.", arythea));
        create(new CartaAccionBasica(4, "Rapidez", Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", arythea));
        create(new CartaAccionBasica(5, "Rapidez", Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", arythea));
        create(new CartaAccionBasica(6, "Marcha", Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", arythea));
        create(new CartaAccionBasica(7, "Marcha", Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", arythea));
        create(new CartaAccionBasica(8, "Resistencia", Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", arythea));
        create(new CartaAccionBasica(9, "Resistencia", Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", arythea));
        create(new CartaAccionBasica(10, "Tranquilidad", Cristal.VERDE, "Curación 1 o roba 1 carta.", "Curación 2 o roba 2 cartas.", arythea));
        create(new CartaAccionBasica(11, "Promesa", Cristal.BLANCO, "Influencia 2.", "Influencia 4.", arythea));
        create(new CartaAccionBasica(12, "Amenaza", Cristal.ROJO, "Influencia 2.", "Influencia 5. Reputación -1.", arythea));
        create(new CartaAccionBasica(13, "Cristalización", Cristal.AZUL, "Cuando juegues esta carta, paga 1 maná de color básico. Gana 1 cristal de ese color para tu inventario.", "Gana 1 cristal de cualquier color para tu Inventario.", arythea));
        create(new CartaAccionBasica(14, "Extracción de Maná", Cristal.BLANCO, "Puedes usar 1 dado de maná adicional de la Fuente en este turno. Si es negro, úsalo para producir maná de cualquier color.", "Toma 2 dados de maná de la Fuente y déjalos en el color que quieras excepto dorado. Gana 1 ficha de maná de cada color. No relances los dados cuando los devuelvas a la Fuente.", arythea));
        create(new CartaAccionBasica(15, "Concentración", Cristal.VERDE, "Gana 1 ficha de maná azul, blanco o rojo.", "Cuando juegues esta carta, juega otra carta de Acción con ella. Gana el efecto avanzado de esa carta sin coste. Si el efecto te otorga Movimiento, Influencia, Bloqueo o cualquier tipo de Ataque, gana la cantidad indicada +2.", arythea));
        create(new CartaAccionBasica(16, "Improvisación", Cristal.ROJO, "Descarta otra carta de tu mano para obtener Movimiento 3, Influencia 3, Ataque 3 o Bloqueo 3.", "Descarta otra carta de tu mano para obtener Movimiento 5, Influencia 5, Ataque 5 o Bloqueo 5.", arythea));

        // 16 cartas del Mazo de Gesta de Tovak (Acción Básica)
        create(new CartaAccionBasica(17, "Rabia", Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", tovak));
        create(new CartaAccionBasica(18, "Rabia", Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", tovak));
        create(new CartaAccionBasica(19, "Dureza Fría", Cristal.AZUL, "Ataque 2 o Bloqueo de Hielo 3.", "Bloqueo de Hielo 5. Gana +1 Bloqueo de Hielo por cada aptitud o color del ataque de la ficha de enemigo bloqueada (a menos que tenga Inmunidad Arcana), o por cada maná utilizado por el oponente durante el ataque.", tovak));
        create(new CartaAccionBasica(20, "Rapidez", Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", tovak));
        create(new CartaAccionBasica(21, "Rapidez", Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", tovak));
        create(new CartaAccionBasica(22, "Marcha", Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", tovak));
        create(new CartaAccionBasica(23, "Marcha", Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", tovak));
        create(new CartaAccionBasica(24, "Resistencia", Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", tovak));
        create(new CartaAccionBasica(25, "Resistencia", Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", tovak));
        create(new CartaAccionBasica(26, "Tranquilidad", Cristal.VERDE, "Curación 1 o roba 1 carta.", "Curación 2 o roba 2 cartas.", tovak));
        create(new CartaAccionBasica(27, "Promesa", Cristal.BLANCO, "Influencia 2.", "Influencia 4.", tovak));
        create(new CartaAccionBasica(28, "Amenaza", Cristal.ROJO, "Influencia 2.", "Influencia 5. Reputación -1.", tovak));
        create(new CartaAccionBasica(29, "Cristalización", Cristal.AZUL, "Cuando juegues esta carta, paga 1 maná de color básico. Gana 1 cristal de ese color para tu inventario.", "Gana 1 cristal de cualquier color para tu Inventario.", tovak));
        create(new CartaAccionBasica(30, "Atracción de Maná", Cristal.BLANCO, "Puedes usar 1 dado de maná adicional de la Fuente en este turno.", "Toma 1 dado de maná de la Fuente y escoge una cara de cualquier color excepto dorado. Gana 2 fichas de maná de ese color. No relances este dado cuando lo devuelvas a la Fuente.", tovak));
        create(new CartaAccionBasica(31, "Concentración", Cristal.VERDE, "Gana 1 ficha de maná azul, blanco o rojo.", "Cuando juegues esta carta, juega otra carta de Acción con ella. Gana el efecto avanzado de esa carta sin coste. Si el efecto te otorga Movimiento, Influencia, Bloqueo o cualquier tipo de Ataque, gana la cantidad indicada +2.", tovak));
        create(new CartaAccionBasica(32, "Instinto", Cristal.ROJO, "Movimiento 2, Influencia 2, Ataque 2 o Bloqueo 2.", "Movimiento 4, Influencia 4, Ataque 4 o Bloqueo 4.", tovak));

        // 16 cartas del Mazo de Gesta de Norowas (Acción Básica)
        create(new CartaAccionBasica(33, "Rabia", Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", norowas));
        create(new CartaAccionBasica(34, "Rabia", Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", norowas));
        create(new CartaAccionBasica(35, "Determinación", Cristal.AZUL, "Ataque o Bloqueo 2.", "Bloqueo 5.", norowas));
        create(new CartaAccionBasica(36, "Rapidez", Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", norowas));
        create(new CartaAccionBasica(37, "Rapidez", Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", norowas));
        create(new CartaAccionBasica(38, "Marcha", Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", norowas));
        create(new CartaAccionBasica(39, "Marcha", Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", norowas));
        create(new CartaAccionBasica(40, "Resistencia", Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", norowas));
        create(new CartaAccionBasica(41, "Resistencia", Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", norowas));
        create(new CartaAccionBasica(42, "Rejuvenecer", Cristal.VERDE, "Curación 1, roba 1 carta, gana 1 ficha de maná verde, o prepara 1 Unidad de nivel I o II.", "Curación 2, roba 2 cartas, gana 1 cristal de maná verde para tu inventario, o prepara 1 Unidad de nivel I, II o III.", norowas));
        create(new CartaAccionBasica(43, "Actos Nobles", Cristal.BLANCO, "Influencia 2. Fama +1 si usas esta carta durante la interacción.", "Influencia 4. Fama +1 y Reputación +1 si usas esta carta durante la interacción.", norowas));
        create(new CartaAccionBasica(44, "Amenaza", Cristal.ROJO, "Influencia 2.", "Influencia 5. Reputación -1.", norowas));
        create(new CartaAccionBasica(45, "Cristalización", Cristal.AZUL, "Cuando juegues esta carta, paga 1 maná de color básico. Gana 1 cristal de ese color para tu inventario.", "Gana 1 cristal de cualquier color para tu Inventario.", norowas));
        create(new CartaAccionBasica(46, "Atracción de Maná", Cristal.BLANCO, "Puedes usar 1 dado de maná adicional de la Fuente en este turno.", "Toma 1 dado de maná de la Fuente y escoge una cara de cualquier color excepto dorado. Gana 2 fichas de maná de ese color. No relances este dado cuando lo devuelvas a la Fuente.", norowas));
        create(new CartaAccionBasica(47, "Concentración", Cristal.VERDE, "Gana 1 ficha de maná azul, blanco o rojo.", "Cuando juegues esta carta, juega otra carta de Acción con ella. Gana el efecto avanzado de esa carta sin coste. Si el efecto te otorga Movimiento, Influencia, Bloqueo o cualquier tipo de Ataque, gana la cantidad indicada +2.", norowas));
        create(new CartaAccionBasica(48, "Improvisación", Cristal.ROJO, "Descarta otra carta de tu mano para obtener Movimiento 3, Influencia 3, Ataque 3 o Bloqueo 3.", "Descarta otra carta de tu mano para obtener Movimiento 5, Influencia 5, Ataque 5 o Bloqueo 5.", norowas));

        // 16 cartas del Mazo de Gesta de Goldyx (Acción Básica)
        create(new CartaAccionBasica(49, "Rabia", Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", goldyx));
        create(new CartaAccionBasica(50, "Rabia", Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", goldyx));
        create(new CartaAccionBasica(51, "Determinación", Cristal.AZUL, "Ataque o Bloqueo 2.", "Bloqueo 5.", goldyx));
        create(new CartaAccionBasica(52, "Rapidez", Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", goldyx));
        create(new CartaAccionBasica(53, "Rapidez", Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", goldyx));
        create(new CartaAccionBasica(54, "Marcha", Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", goldyx));
        create(new CartaAccionBasica(55, "Marcha", Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", goldyx));
        create(new CartaAccionBasica(56, "Resistencia", Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", goldyx));
        create(new CartaAccionBasica(57, "Resistencia", Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", goldyx));
        create(new CartaAccionBasica(58, "Tranquilidad", Cristal.VERDE, "Curación 1 o roba 1 carta.", "Curación 2 o roba 2 cartas.", goldyx));
        create(new CartaAccionBasica(59, "Promesa", Cristal.BLANCO, "Influencia 2.", "Influencia 4.", goldyx));
        create(new CartaAccionBasica(60, "Amenaza", Cristal.ROJO, "Influencia 2.", "Influencia 5. Reputación -1.", goldyx));
        create(new CartaAccionBasica(61, "Alegría Cristalizada", Cristal.AZUL, "Paga 1 maná de cualquier color básico para ganar 1 cristal de ese color para tu inventario. Al final de tu turno, puedes descartar otra carta que no sea Herida para devolver esta carta a tu mano.", "Gana 1 cristal de cualquier color básico para tu inventario. Al final de tu turno, puedes descartar otra carta (incluso una Herida) para", goldyx));
        create(new CartaAccionBasica(62, "Atracción de Maná", Cristal.BLANCO, "Puedes usar 1 dado de maná adicional de la Fuente en este turno.", "Toma 1 dado de maná de la Fuente y escoge una cara de cualquier color excepto dorado. Gana 2 fichas de maná de ese color. No relances este dado cuando lo devuelvas a la Fuente.", goldyx));
        create(new CartaAccionBasica(63, "Enfoque Decisivo", Cristal.VERDE, "Gana 1 ficha de maná azul, blanco o rojo o bien 1 cristal verde para tu inventario.", "Cuando juegues esta carta, juega otra carta de Acción con ella. Gana el efecto avanzado de esa carta sin coste. Si el efecto te otorga Movimiento, Influencia, Bloqueo o cualquier tipo de Ataque, gana la cantidad indicada +3.", goldyx));
        create(new CartaAccionBasica(64, "Improvisación", Cristal.ROJO, "Descarta otra carta de tu mano para obtener Movimiento 3, Influencia 3, Ataque 3 o Bloqueo 3.", "Descarta otra carta de tu mano para obtener Movimiento 5, Influencia 5, Ataque 5 o Bloqueo 5.", goldyx));

        // 16 cartas del Mazo de Gesta de Wolfhawk (Acción Básica)
        create(new CartaAccionBasica(271, "Rabia", Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", wolfhawk));
        create(new CartaAccionBasica(272, "Rabia", Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", wolfhawk));
        create(new CartaAccionBasica(273, "Determinación", Cristal.AZUL, "Ataque o Bloqueo 2.", "Bloqueo 5.", wolfhawk));
        create(new CartaAccionBasica(274, "Reflejos Instantáneos", Cristal.BLANCO, "Movimiento 2, Ataque a Distancia 1, o reduce el ataque de un enemigo en 1.", "Movimiento 4, Ataque a Distancia 3, o reduce el ataque de un enemigo en 2.", wolfhawk));
        create(new CartaAccionBasica(275, "Rapidez", Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", wolfhawk));
        create(new CartaAccionBasica(276, "Marcha", Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", wolfhawk));
        create(new CartaAccionBasica(277, "Marcha", Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", wolfhawk));
        create(new CartaAccionBasica(278, "Incansable", Cristal.AZUL, "Movimiento 2. Con la siguiente carta que otorgue Movimiento (Incluidas las cartas giradas) obtienes +1 Movimiento en este turno.", "Movimiento 4. Con cualquier otra carta que otorgue Movimiento (Incluidas las cartas giradas) obtienes +1 Movimiento en este turno.", wolfhawk));
        create(new CartaAccionBasica(279, "Resistencia", Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", wolfhawk));
        create(new CartaAccionBasica(280, "Tranquilidad", Cristal.VERDE, "Curación 1 o roba 1 carta.", "Curación 2 o roba 2 cartas.", wolfhawk));
        create(new CartaAccionBasica(281, "Promesa", Cristal.BLANCO, "Influencia 2.", "Influencia 4.", wolfhawk));
        create(new CartaAccionBasica(282, "Amenaza", Cristal.ROJO, "Influencia 2.", "Influencia 5. Reputación -1.", wolfhawk));
        create(new CartaAccionBasica(283, "Cristalización", Cristal.AZUL, "Cuando juegues esta carta, paga 1 maná de color básico. Gana 1 cristal de ese color para tu inventario.", "Gana 1 cristal de cualquier color para tu Inventario.", wolfhawk));
        create(new CartaAccionBasica(284, "Atracción de Maná", Cristal.BLANCO, "Puedes usar 1 dado de maná adicional de la Fuente en este turno.", "Toma 1 dado de maná de la Fuente y escoge una cara de cualquier color excepto dorado. Gana 2 fichas de maná de ese color. No relances este dado cuando lo devuelvas a la Fuente.", wolfhawk));
        create(new CartaAccionBasica(285, "Concentración", Cristal.VERDE, "Gana 1 ficha de maná azul, blanco o rojo.", "Cuando juegues esta carta, juega otra carta de Acción con ella. Gana el efecto avanzado de esa carta sin coste. Si el efecto te otorga Movimiento, Influencia, Bloqueo o cualquier tipo de Ataque, gana la cantidad indicada +2.", wolfhawk));
        create(new CartaAccionBasica(286, "Improvisación", Cristal.ROJO, "Descarta otra carta de tu mano para obtener Movimiento 3, Influencia 3, Ataque 3 o Bloqueo 3.", "Descarta otra carta de tu mano para obtener Movimiento 5, Influencia 5, Ataque 5 o Bloqueo 5.", wolfhawk));

        // 16 cartas del Mazo de Gesta de Krang (Acción Básica)
        create(new CartaAccionBasica(337, "Rabia", Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", krang));
        create(new CartaAccionBasica(338, "Rabia", Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", krang));
        create(new CartaAccionBasica(339, "Determinación", Cristal.AZUL, "Ataque o Bloqueo 2.", "Bloqueo 5.", krang));
        create(new CartaAccionBasica(340, "Rapidez", Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", krang));
        create(new CartaAccionBasica(341, "Rapidez", Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", krang));
        create(new CartaAccionBasica(342, "Cosecha Salvaje", Cristal.VERDE, "Movimiento 2. Una vez en este turno, cuando te muevas un espacio, puedes descartar 1 carta para ganar 1 cristal del mismo color. Si descartas 1 Artefacto puedes escoger el color.", "Movimiento 4. Cada vez que te muevas un espacio en este turno, puedes descartar 1 carta para ganar 1 cristal del mismo color. Si descartas 1 Artefacto puedes escoger el color.", krang));
        create(new CartaAccionBasica(343, "Marcha", Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", krang));
        create(new CartaAccionBasica(344, "Resistencia", Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", krang));
        create(new CartaAccionBasica(345, "Resistencia", Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", krang));
        create(new CartaAccionBasica(346, "Tranquilidad", Cristal.VERDE, "Curación 1 o roba 1 carta.", "Curación 2 o roba 2 cartas.", krang));
        create(new CartaAccionBasica(347, "Promesa", Cristal.BLANCO, "Influencia 2.", "Influencia 4.", krang));
        create(new CartaAccionBasica(348, "Extorsión Implacable", Cristal.ROJO, "Influencia 2. Puedes obtener un descuento de 2 en el coste de reclutamiento de 1 Unidad. Si reclutas esa Unidad en este turno, obtienes Reputación -1.", "Influencia 6. Reputación -1. Puedes preparar Unidades de nivel I y II que controles pagando 2 de Influencia por cada nivel de la Unidad.", krang));
        create(new CartaAccionBasica(349, "Cristalización", Cristal.AZUL, "Cuando juegues esta carta, paga 1 maná de color básico. Gana 1 cristal de ese color para tu inventario.", "Gana 1 cristal de cualquier color para tu Inventario.", krang));
        create(new CartaAccionBasica(350, "Atracción de Maná", Cristal.BLANCO, "Puedes usar 1 dado de maná adicional de la Fuente en este turno.", "Toma 1 dado de maná de la Fuente y escoge una cara de cualquier color excepto dorado. Gana 2 fichas de maná de ese color. No relances este dado cuando lo devuelvas a la Fuente.", krang));
        create(new CartaAccionBasica(351, "Concentración", Cristal.VERDE, "Gana 1 ficha de maná azul, blanco o rojo.", "Cuando juegues esta carta, juega otra carta de Acción con ella. Gana el efecto avanzado de esa carta sin coste. Si el efecto te otorga Movimiento, Influencia, Bloqueo o cualquier tipo de Ataque, gana la cantidad indicada +2.", krang));
        create(new CartaAccionBasica(352, "Improvisación", Cristal.ROJO, "Descarta otra carta de tu mano para obtener Movimiento 3, Influencia 3, Ataque 3 o Bloqueo 3.", "Descarta otra carta de tu mano para obtener Movimiento 5, Influencia 5, Ataque 5 o Bloqueo 5.", krang));

        // 16 cartas del Mazo de Gesta de Braevalar (Acción Básica)
        create(new CartaAccionBasica(356, "Rabia", Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", braevalar));
        create(new CartaAccionBasica(357, "Rabia", Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", braevalar));
        create(new CartaAccionBasica(358, "Determinación", Cristal.AZUL, "Ataque o Bloqueo 2.", "Bloqueo 5.", braevalar));
        create(new CartaAccionBasica(359, "Rapidez", Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", braevalar));
        create(new CartaAccionBasica(360, "Rapidez", Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", braevalar));
        create(new CartaAccionBasica(361, "Marcha", Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", braevalar));
        create(new CartaAccionBasica(362, "Unido con la Tierra", Cristal.VERDE, "Movimiento 2, Curación 1, o Bloqueo 2.", "Movimiento 4, Curación 2, o Bloqueo igual al coste de Movimiento sin modificar del espacio en el que te encuentras (Montañas 5, Lagos 2). Bloqueo de Fuego durante el Día y Bloqueo de Hielo durante la Noche.", braevalar));
        create(new CartaAccionBasica(363, "Resistencia", Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", braevalar));
        create(new CartaAccionBasica(364, "Sendas del Druida", Cristal.AZUL, "Movimiento 2. El coste de Movimiento de un espacio se reduce en 1 en este turno, hasta un mínimo de 2.", "Movimiento 4. El coste de Movimiento de un tipo de terreno se reduce en 1 en este turno, hasta un mínimo de 2.", braevalar));
        create(new CartaAccionBasica(365, "Tranquilidad", Cristal.VERDE, "Curación 1 o roba 1 carta.", "Curación 2 o roba 2 cartas.", braevalar));
        create(new CartaAccionBasica(366, "Promesa", Cristal.BLANCO, "Influencia 2.", "Influencia 4.", braevalar));
        create(new CartaAccionBasica(367, "Amenaza", Cristal.ROJO, "Influencia 2.", "Influencia 5. Reputación -1.", braevalar));
        create(new CartaAccionBasica(368, "Cristalización", Cristal.AZUL, "Cuando juegues esta carta, paga 1 maná de color básico. Gana 1 cristal de ese color para tu inventario.", "Gana 1 cristal de cualquier color para tu Inventario.", braevalar));
        create(new CartaAccionBasica(369, "Atracción de Maná", Cristal.BLANCO, "Puedes usar 1 dado de maná adicional de la Fuente en este turno.", "Toma 1 dado de maná de la Fuente y escoge una cara de cualquier color excepto dorado. Gana 2 fichas de maná de ese color. No relances este dado cuando lo devuelvas a la Fuente.", braevalar));
        create(new CartaAccionBasica(370, "Concentración", Cristal.VERDE, "Gana 1 ficha de maná azul, blanco o rojo.", "Cuando juegues esta carta, juega otra carta de Acción con ella. Gana el efecto avanzado de esa carta sin coste. Si el efecto te otorga Movimiento, Influencia, Bloqueo o cualquier tipo de Ataque, gana la cantidad indicada +2.", braevalar));
        create(new CartaAccionBasica(371, "Improvisación", Cristal.ROJO, "Descarta otra carta de tu mano para obtener Movimiento 3, Influencia 3, Ataque 3 o Bloqueo 3.", "Descarta otra carta de tu mano para obtener Movimiento 5, Influencia 5, Ataque 5 o Bloqueo 5.", braevalar));

        // 28 cartas de Acción Avanzada (juego base)
        create(new CartaAccionAvanzada(65, "Rayo de Fuego", Cristal.ROJO, "Gana 1 cristal rojo para tu Inventario.", "Ataque a Distancia de Fuego 3."));
        create(new CartaAccionAvanzada(66, "Rayo de Hielo", Cristal.AZUL, "Gana 1 cristal azul para tu Inventario.", "Ataque a Distancia de Hielo 3."));
        create(new CartaAccionAvanzada(67, "Rayo Fulminante", Cristal.BLANCO, "Gana 1 cristal blanco para tu Inventario.", "Ataque a Distancia 4."));
        create(new CartaAccionAvanzada(68, "Rayo Devastador", Cristal.VERDE, "Gana 1 cristal verde para tu Inventario.", "Ataque de Asedio 3."));
        create(new CartaAccionAvanzada(69, "Furia Sangrienta", Cristal.ROJO, "Ataque 2. Puedes recibir 1 Herida para aumentar a Ataque 5.", "Ataque 4. Puedes recibir 1 Herida para aumentar a Ataque 9."));
        create(new CartaAccionAvanzada(70, "Escudo de Hielo", Cristal.AZUL, "Bloqueo de Hielo 3.", "Bloqueo de Hielo 3. Reduce en 3 la Armadura de un enemigo bloqueado de esta manera. La Armadura no puede ser reducida por debajo de 1."));
        create(new CartaAccionAvanzada(71, "Agilidad", Cristal.BLANCO, "Movimiento 2. Durante un combate en este turno, puedes gastar puntos de Movimiento para obtener Ataque 1: uno por cada punto.", "Movimiento 4. Durante un combate en este turno, puedes gastar puntos de Movimiento: 2 para Ataque a Distancia 1 y/o 1 para Ataque 1."));
        create(new CartaAccionAvanzada(72, "Paseo Reparador", Cristal.VERDE, "Movimiento 2 y Curación 1. Durante el combate: solo Movimiento 2.", "Movimiento 4 y Curación 2. Durante el combate: solo Movimiento 4."));
        create(new CartaAccionAvanzada(73, "Intimidación", Cristal.ROJO, "Influencia 4 o Ataque 3. Reputación -1.", "Influencia 8 o Ataque 7. Reputación -2."));
        create(new CartaAccionAvanzada(74, "Puente Helado", Cristal.AZUL, "Movimiento 2. El coste de Movimiento de pantanos se reduce a 1 en este turno.", "Movimiento 4. Puedes moverte a través de lagos. El coste de Movimiento de lagos y pantanos se reduce a 1 en este turno."));
        create(new CartaAccionAvanzada(75, "Canción del Viento", Cristal.BLANCO, "Movimiento 2. El coste de Movimiento de llanuras, desiertos y páramos se reduce en 1, hasta un mínimo de 0 en este turno.", "Movimiento 2. El Movimiento de llanuras, desiertos y páramos se reduce en 2, hasta un mínimo de 0 este turno. Puedes pagar un maná azul para moverte a través de lagos con un coste de Movimiento 0 este turno."));
        create(new CartaAccionAvanzada(76, "Búsqueda del Camino", Cristal.VERDE, "Movimiento 2. El coste de Movimiento de todos los terrenos se reduce en 1, hasta un mínimo de 2 en este turno.", "Movimiento 4. El coste de Movimiento de todos los terrenos se reduce a 2 en este turno."));
        create(new CartaAccionAvanzada(77, "Ritual de Sangre", Cristal.ROJO, "Recibe 1 Herida. Gana 1 cristal de maná rojo para tu inventario y 1 ficha de maná de cualquier color (incluidos los no básicos).", "Recibe 1 Herida. Gana 3 fichas de maná de cualquier color (Incluidos los no básicos). Puedes pagar 1 maná de cualquier color básico para ganar 1 cristal de ese color para tu inventario."));
        create(new CartaAccionAvanzada(78, "Magia Pura", Cristal.AZUL, "Cuando juegues esta carta, paga 1 maná. Si pagas verde, Movimiento 4. Si pagas blanco, Influencia 4. Si pagas azul, Bloqueo 4. Si pagas rojo, Ataque 4.", "Cuando juegues esta carta, paga 1 maná. Si pagas verde, Movimiento 7. Si pagas blanco, Influencia 7. Si pagas azul, Bloqueo 7. Si pagas rojo, Ataque 7."));
        create(new CartaAccionAvanzada(79, "Cuento Heroico", Cristal.BLANCO, "Influencia 3. Por cada Unidad que hayas reclutado en este turno, Reputación +1.", "Influencia 6. Por cada Unidad que hayas reclutado en este turno, Fama +1 y Reputación +1."));
        create(new CartaAccionAvanzada(80, "Regeneración", Cristal.VERDE, "Curación 1. Prepara 1 Unidad de Nivel I o II que controles.", "Curación 2. Prepara 1 Unidad de Nivel I, II o III que controles."));
        create(new CartaAccionAvanzada(81, "Hacia el Fragor", Cristal.ROJO, "Juega esta carta al principio del combate. Todas tus Unidades aumentan sus valores de Ataque y Bloqueo en +2 durante este combate. No puedes asignar daño a tus Unidades en este turno.", "Juega esta carta al principio del combate. Todas tus Unidades aumentan sus valores de Ataque y Bloqueo en +3 durante este combate. No puedes asignar daño a tus Unidades en este turno."));
        create(new CartaAccionAvanzada(82, "Ritmo Constante", Cristal.AZUL, "Movimiento 2. Al final de tu turno, en lugar de colocar esta carta en tu pila de descarte, puedes colocarla en la parte inferior de tu mazo de Gesta, siempre y cuando no esté vacío.", "Movimiento 4. Al final de tu turno, en lugar de colocar esta carta en tu pila de descarte, puedes colocarla en la parte superior de tu mazo de Gesta."));
        create(new CartaAccionAvanzada(83, "Diplomacia", Cristal.BLANCO, "Influencia 2. Puedes usar Influencia como Bloqueo en este turno.", "Influencia 4. Elige Hielo o Fuego. Puedes usar Influencia como Bloqueo del elemento elegido en este turno."));
        create(new CartaAccionAvanzada(84, "Necesitado", Cristal.VERDE, "Influencia 3. Gana Influencia, +1 adicional por cada carta de Herida en tu mano o en Unidades que controles.", "Influencia 5. Gana Influencia, +2 adicional por cada carta de Herida en tu mano o en Unidades que controles."));
        create(new CartaAccionAvanzada(85, "Descomposición", Cristal.ROJO, "Cuando juegues esta carta, retira 1 carta de Acción de tu mano. Gana para tu inventario 2 cristales del mismo color que la carta retirada.", "Cuando juegues esta carta, retira 1 carta de Acción de tu mano. Gana para tu inventario 1 cristal de cada color básico que no coincida con el color de la carta retirada."));
        create(new CartaAccionAvanzada(86, "Dominio del Cristal", Cristal.AZUL, "Gana 1 cristal para tu Inventario del mismo color que un cristal que ya poseas.", "Al final del turno, cualquier cristal que hayas utilizado en este turno se devuelve a tu inventario."));
        create(new CartaAccionAvanzada(87, "Tormenta de Maná", Cristal.BLANCO, "Elige de la Fuente 1 dado de maná de color básico. Gana 1 cristal de ese color para tu inventario. Relanza ese dado inmediatamente y devuélvelo a la Fuente.", "Relanza los dados de la Fuente. Puedes utilizar 3 dados extra, y puedes usar dados de maná negro o dorado como cualquier color básico, independientemente de la Ronda."));
        create(new CartaAccionAvanzada(88, "Emboscada", Cristal.VERDE, "Movimiento 2. Añade +1 a tu primera carta de Ataque de cualquier tipo o +2 a tu primera carta de Bloqueo de cualquier tipo, lo primero que juegues en este turno.", "Movimiento 4. Añade +2 a tu primera carta de Ataque de cualquier tipo o +4 a tu primera carta de Bloqueo, lo primero que juegues en este turno."));
        create(new CartaAccionAvanzada(89, "Máxima Efectividad", Cristal.ROJO, "Cuando juegues esta carta, retira otra carta de Acción de tu mano. Usa 3 veces el efecto básico de la carta retirada.", "Cuando juegues esta carta, retira otra carta de Acción de tu mano. Usa 2 veces el efecto avanzado de la carta retirada (sin coste)."));
        create(new CartaAccionAvanzada(90, "Talento Mágico", Cristal.AZUL, "Descarta 1 carta de cualquier color. Puedes jugar 1 carta de Hechizo de ese color de la oferta de Hechizos en este turno como si estuviera en tu mano. La carta permanece en la oferta de Hechizos.", "Cuando juegues esta carta, paga 1 maná de cualquier color. Gana 1 carta de Hechizo de ese color de la oferta de Hechizos y colócala en tu pila de descarte."));
        create(new CartaAccionAvanzada(91, "Aprendizaje", Cristal.BLANCO, "Influencia 2. Una vez en este turno, puedes pagar Influencia 6 para obtener 1 carta de Acción Avanzada de la oferta de Acciones Avanzadas y colocarla en tu pila de descarte.", "Influencia 4. Una vez en este turno, puedes pagar Influencia 9 para obtener 1 carta de Acción Avanzada de la oferta de Acciones Avanzadas y colocarla en tu mano."));
        create(new CartaAccionAvanzada(92, "Entrenamiento", Cristal.VERDE, "Retira 1 carta de Acción de tu mano para tomar 1 carta del mismo color de la oferta de Acciones Avanzadas y colocarla en tu pila de descarte.", "Retira 1 carta de Acción de tu mano para tomar 1 carta del mismo color de la oferta de Acciones Avanzadas y colocarla en tu mano."));
        ...
        create(new CartaAccionAvanzadaEspecial(266, "Poder de los Cristales", Cristal.VERDE,  Cristal.AZUL, "Gana 1 cristal para tu Inventario de un color básico que aún no tengas.", "Movimiento 4, o Curación 2, o roba dos cartas. Por cada conjunto de 4 cristales de diferentes colores en tu Inventario: Movimiento 2, o Curación 1, o roba una carta."));
        create(new CartaAccionAvanzadaEspecial(267, "Descarga de Adrenalina", Cristal.ROJO, Cristal.VERDE, "Por cada una de las primeras 3 Heridas que llevas a la mano en este turno, roba 1 carta.", "Tras tomar la primera Herida a la mano en este turno, retírala y roba 1 carta. Por cada 1 de las 3 Heridas siguientes que tomes, roba 1 carta."));
        create(new CartaAccionAvanzadaEspecial(268, "Rayo Explosivo", Cristal.BLANCO, Cristal.ROJO, "Recibe 1 Herida. Gana 1 cristal blanco y rojo para tu Inventario.", "Ataque a Distancia 3. Por cada enemigo derrotado con este ataque, otro enemigo obtiene Armadura -1 (hasta un mínimo de 1)."));
        create(new CartaAccionAvanzadaEspecial(269, "Mirada Penetrante", Cristal.AZUL, Cristal.BLANCO, "Influencia 3, o el ataque del enemigo objetivo pierde todas sus aptitudes (pero no su color).", "Influencia 5, o el enemigo objetivo no ataca en este turno."));

        // 12 cartas de Acción Avanzada (Legión Perdida)
        create(new CartaAccionAvanzada(287, "Contraataque", Cristal.ROJO, "Ataque 2. Gana Ataque 2 adicional por cada enemigo bloqueado en este turno.", "Ataque 4. Gana Ataque 3 adicional por cada enemigo bloqueado en este turno."));
        create(new CartaAccionAvanzada(288, "Ritual de Ataque", Cristal.ROJO, "Retira otra carta de acción. En función de su color, gana: Rojo: Ataque 5, Azul: Ataque de Hielo 3, Blanco: Ataque a Distancia 3, Verde: Ataque de Asedio 2.", "Retira otra carta de acción. En función de su color, gana: Rojo: Ataque de Fuego 6, Azul: Ataque de Fuego Frío 4, Blanco: Ataque a Distancia de Fuego 4, Verde: Ataque de Asedio de Fuego 3."));
        create(new CartaAccionAvanzada(289, "Sangre Ancestral", Cristal.ROJO, "Recibe 1 Herida. Paga 1 maná de cualquier color. Gana 1 carta de ese color de la oferta de Acciones Avanzadas y colócala en tu mano.", "Recibe 1 Herida a tu mano o pila de descarte. Utiliza el efecto avanzado de cualquier carta de la oferta de Acciones Avanzadas sin pagar su coste. La carta permanece en la oferta."));
        create(new CartaAccionAvanzada(290, "Golpe de Escudo", Cristal.AZUL, "Bloqueo 3. Cuenta el doble contra un ataque Veloz.", "Bloqueo 5. Cuenta el doble contra un ataque Veloz. El enemigo bloqueado obtiene Armadura -1 por cada punto de bloqueo sobrante (hasta un mínimo de 1)."));
        create(new CartaAccionAvanzada(291, "Portal Temporal", Cristal.AZUL, "Juega esta carta como tu acción en este turno. Puedes moverte a un espacio seguro adyacente revelado (sin provocar enemigos acechantes). Tanto si te mueves como si no, tu límite de mano aumenta en 1 la próxima vez que robes cartas.", "Lo mismo que el efecto básico, excepto que puedes o moverte hacia un espacio seguro 2 espacios en vez de uno, o aumentar tu límite de mano en 2 en vez de 1."));
        create(new CartaAccionAvanzada(292, "Hechizo Forjado", Cristal.AZUL, "Gana 1 cristal para tu Inventario del mismo color de 1 de los Hechizos en la oferta de Hechizos.", "Gana 2 cristales para tu Inventario de los mismos colores que 2 Hechizos diferentes en la oferta de Hechizos."));
        create(new CartaAccionAvanzada(293, "Cortesía", Cristal.BLANCO, "Ataque 3, o Ataque 2 y Reputación +1 por cada enemigo derrotado por este ataque.", "Ataque 6, o Ataque 4 y Reputación +1 y Fama +1 por cada enemigo derrotado por este ataque."));
        create(new CartaAccionAvanzada(294, "Momento de Paz", Cristal.BLANCO, "Influencia 3. Puedes jugar esta carta como tu acción en este turno: si lo haces, puedes obtener Curación 1 por cada 2 de Influencia que hayas gastado.", "Influencia 6. Puedes jugar esta carta como tu acción en este turno: si lo haces, puedes obtener Curación 1 por cada 2 de Influencia que hayas gastado y/o preparar una Unidad pagando 2 de Influencia por cada nivel de la Unidad."));
        create(new CartaAccionAvanzada(295, "Esquivar y Evitar", Cristal.BLANCO, "Reduce el ataque de un enemigo en 2. Gana Ataque 1 en la fase de Ataque si no añadiste Heridas a tu mano en las fases previas del combate.", "Reduce el ataque de un enemigo en 4 o 2 ataques de 1 o 2 enemigos en 2. Gana Ataque 2 en la fase de Ataque si no añadiste Heridas a tu mano en las fases previas del combate."));
        create(new CartaAccionAvanzada(296, "Decisión Valiente", Cristal.VERDE, "Movimiento 2, Influencia 2, Ataque 2 o Bloqueo 2. Puedes descartar 1 Herida para aumentar el efecto en 1.", "Movimiento 3, Influencia 3, Ataque 3 o Bloqueo 3. Puedes descartar cualquier número de cartas, incluyendo 1 Herida, para incrementar el efecto en 2 por cada una."));
        create(new CartaAccionAvanzada(297, "Fuerza de la Naturaleza", Cristal.VERDE, "La Unidad elegida gana Resistencia Física en este combate.", "Ataque de Asedio 3 o Bloqueo 6"));
        create(new CartaAccionAvanzada(298, "Sabiduría de la Montaña", Cristal.VERDE, "Movimiento 3. Si finalizas tu turno en la colinas, tu límite de Mano aumenta en 1 la próxima vez que robes cartas.", "Movimiento 5. Puedes entrar en Montañas con un coste de Movimiento 5 y se considerarán un espacio seguro para ti hasta el final de este turno. Si finalizas tu turno en montañas/colinas, tu límite de Mano aumenta en 2/1 la próxima vez que robes cartas."));
