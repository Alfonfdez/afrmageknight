...
public class DatabaseHelperInsertInitialData extends DatabaseHelper{
    ...
    //Métodos para realizar operaciones CRUD (Create, Read, Update, Delete)
    public boolean insertDataCartaTactica(int idFicha, TipoTactica tipoTactica, int numeroOrden, String descripcion){
        ...
        contentValues.put(COL_1_CARTAS_TACTICAS_TABLE, idFicha);
