...
public class DatabaseHelperInsertInitialData extends DatabaseHelper{
    ...
    //Métodos que sobreescriben e implementan los métodos de DatabaseHelper y, por consiguiente, de SQLiteOpenHelper
    @Override
    public void onCreate(SQLiteDatabase db) {
        ...
        Log.d("DATABASE", "CUARTO - ONCREATE_GAME DATA - PARTIDA_CARTAS_HEROE_DUMMY_TABLE");
    ...
    //Métodos para realizar operaciones CRUD (Create, Read, Update, Delete)
    public boolean insertDataCarta(int numero, String nombre, boolean isDescartada){
    ...
    //Métodos para realizar operaciones CRUD (Create, Read, Update, Delete)
    public boolean insertDataCartaAccion(int numero, String color, String descripcionBasica, String descripcionAvanzada){
    ...
    //Métodos para realizar operaciones CRUD (Create, Read, Update, Delete)
    public boolean insertDataCartaTactica(int numero, String tipoTactica, int numeroOrden, String descripcion){
    ...
    public Carta createCarta(Carta carta){
        ...
        insertDataCarta(carta.getNumero(), carta.getNombre(), carta.isDescartada());
        ...
        if(carta.getClass() == CartaTactica.class){
            ...
            insertDataCartaTactica(carta.getNumero(), cartaTactica.getTipoTactica().toString(), cartaTactica.getNumeroOrden(), cartaTactica.getDescripcion());
        ...
        insertDataCartaAccion(carta.getNumero(), cartaAccion.getColor().toString(), cartaAccion.getDescripcionBasica(), cartaAccion.getDescripcionAvanzada());
        ...
        if (carta.getClass() == CartaAccionBasica.class){
            ...
            insertDataCartaHechizo(carta.getNumero(), cartaAccionHechizohechizo.getNombreSecundario());
        }
    ...
    public void insertAllData(){
        ...
        createCarta(new CartaAccionBasica(1, "Versatilidad en la Batalla",false, Cristal.ROJO, "Ataque 2, Bloqueo 2 o Ataque a Distancia 1.", "Ataque 4, Bloqueo 4, Ataque de Fuego 3, Bloqueo de Fuego 3, Ataque a Distancia 3 o Ataque de Asedio 2.", arythea));
        createCarta(new CartaAccionBasica(2, "Rabia", false, Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", arythea));
        createCarta(new CartaAccionBasica(3, "Determinación", false, Cristal.AZUL, "Ataque o Bloqueo 2.", "Bloqueo 5.", arythea));
        createCarta(new CartaAccionBasica(4, "Rapidez", false, Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", arythea));
        createCarta(new CartaAccionBasica(5, "Rapidez", false, Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", arythea));
        createCarta(new CartaAccionBasica(6, "Marcha", false, Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", arythea));
        createCarta(new CartaAccionBasica(7, "Marcha", false, Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", arythea));
        createCarta(new CartaAccionBasica(8, "Resistencia", false, Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", arythea));
        createCarta(new CartaAccionBasica(9, "Resistencia", false, Cristal.AZUL, "Movimiento 2.", "Movimiento 4.",arythea));
        createCarta(new CartaAccionBasica(10, "Tranquilidad", false, Cristal.VERDE, "Curación 1 o roba 1 carta.", "Curación 2 o roba 2 cartas.", arythea));
        createCarta(new CartaAccionBasica(11, "Promesa", false, Cristal.BLANCO, "Influencia 2.", "Influencia 4.", arythea));
        createCarta(new CartaAccionBasica(12, "Amenaza", false, Cristal.ROJO, "Influencia 2.", "Influencia 5. Reputación -1.", arythea));
        createCarta(new CartaAccionBasica(13, "Cristalización", false, Cristal.AZUL, "Cuando juegues esta carta, paga 1 maná de color básico. Gana 1 cristal de ese color para tu inventario.", "Gana 1 cristal de cualquier color para tu Inventario.", arythea));
        ...
        createCarta(new CartaAccionBasica(16, "Improvisación", false, Cristal.ROJO, "Descarta otra carta de tu mano para obtener Movimiento 3, Influencia 3, Ataque 3 o Bloqueo 3.", "Descarta otra carta de tu mano para obtener Movimiento 5, Influencia 5, Ataque 5 o Bloqueo 5.",arythea));

        // 16 cartas del Mazo de Gesta de Tovak (Acción Básica)
        createCarta(new CartaAccionBasica(17, "Rabia", false, Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", tovak));
        createCarta(new CartaAccionBasica(18, "Rabia", false, Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", tovak));
        ...
        createCarta(new CartaAccionBasica(20, "Rapidez", false, Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", tovak));
        createCarta(new CartaAccionBasica(21, "Rapidez", false, Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", tovak));
        createCarta(new CartaAccionBasica(22, "Marcha", false, Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", tovak));
        createCarta(new CartaAccionBasica(23, "Marcha", false, Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", tovak));
        createCarta(new CartaAccionBasica(24, "Resistencia", false, Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", tovak));
        createCarta(new CartaAccionBasica(25, "Resistencia", false, Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", tovak));
        createCarta(new CartaAccionBasica(26, "Tranquilidad", false, Cristal.VERDE, "Curación 1 o roba 1 carta.", "Curación 2 o roba 2 cartas.", tovak));
        createCarta(new CartaAccionBasica(27, "Promesa", false, Cristal.BLANCO, "Influencia 2.", "Influencia 4.", tovak));
        createCarta(new CartaAccionBasica(28, "Amenaza", false, Cristal.ROJO, "Influencia 2.", "Influencia 5. Reputación -1.", tovak));
        createCarta(new CartaAccionBasica(29, "Cristalización", false, Cristal.AZUL, "Cuando juegues esta carta, paga 1 maná de color básico. Gana 1 cristal de ese color para tu inventario.", "Gana 1 cristal de cualquier color para tu Inventario.", tovak));
        ...
        createCarta(new CartaAccionBasica(32, "Instinto", false, Cristal.ROJO, "Movimiento 2, Influencia 2, Ataque 2 o Bloqueo 2.", "Movimiento 4, Influencia 4, Ataque 4 o Bloqueo 4.", tovak));

        // 16 cartas del Mazo de Gesta de Norowas (Acción Básica)
        createCarta(new CartaAccionBasica(33, "Rabia", false, Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", norowas));
        createCarta(new CartaAccionBasica(34, "Rabia", false, Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", norowas));
        createCarta(new CartaAccionBasica(35, "Determinación", false, Cristal.AZUL, "Ataque o Bloqueo 2.", "Bloqueo 5.", norowas));
        createCarta(new CartaAccionBasica(36, "Rapidez", false, Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", norowas));
        createCarta(new CartaAccionBasica(37, "Rapidez", false, Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", norowas));
        createCarta(new CartaAccionBasica(38, "Marcha", false, Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", norowas));
        createCarta(new CartaAccionBasica(39, "Marcha", false, Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", norowas));
        createCarta(new CartaAccionBasica(40, "Resistencia", false, Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", norowas));
        createCarta(new CartaAccionBasica(41, "Resistencia", false, Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", norowas));
        createCarta(new CartaAccionBasica(42, "Rejuvenecer", false, Cristal.VERDE, "Curación 1, roba 1 carta, gana 1 ficha de maná verde, o prepara 1 Unidad de nivel I o II.", "Curación 2, roba 2 cartas, gana 1 cristal de maná verde para tu inventario, o prepara 1 Unidad de nivel I, II o III.", norowas));
        createCarta(new CartaAccionBasica(43, "Actos Nobles", false, Cristal.BLANCO, "Influencia 2. Fama +1 si usas esta carta durante la interacción.", "Influencia 4. Fama +1 y Reputación +1 si usas esta carta durante la interacción.", norowas));
        createCarta(new CartaAccionBasica(44, "Amenaza", false, Cristal.ROJO, "Influencia 2.", "Influencia 5. Reputación -1.", norowas));
        createCarta(new CartaAccionBasica(45, "Cristalización", false, Cristal.AZUL, "Cuando juegues esta carta, paga 1 maná de color básico. Gana 1 cristal de ese color para tu inventario.", "Gana 1 cristal de cualquier color para tu Inventario.", norowas));
        ...
        createCarta(new CartaAccionBasica(48, "Improvisación", false, Cristal.ROJO, "Descarta otra carta de tu mano para obtener Movimiento 3, Influencia 3, Ataque 3 o Bloqueo 3.", "Descarta otra carta de tu mano para obtener Movimiento 5, Influencia 5, Ataque 5 o Bloqueo 5.", norowas));

        // 16 cartas del Mazo de Gesta de Goldyx (Acción Básica)
        createCarta(new CartaAccionBasica(49, "Rabia", false, Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", goldyx));
        createCarta(new CartaAccionBasica(50, "Rabia", false, Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", goldyx));
        createCarta(new CartaAccionBasica(51, "Determinación", false, Cristal.AZUL, "Ataque o Bloqueo 2.", "Bloqueo 5.", goldyx));
        createCarta(new CartaAccionBasica(52, "Rapidez", false, Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", goldyx));
        createCarta(new CartaAccionBasica(53, "Rapidez", false, Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", goldyx));
        createCarta(new CartaAccionBasica(54, "Marcha", false, Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", goldyx));
        createCarta(new CartaAccionBasica(55, "Marcha", false, Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", goldyx));
        createCarta(new CartaAccionBasica(56, "Resistencia", false, Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", goldyx));
        createCarta(new CartaAccionBasica(57, "Resistencia", false, Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", goldyx));
        createCarta(new CartaAccionBasica(58, "Tranquilidad", false, Cristal.VERDE, "Curación 1 o roba 1 carta.", "Curación 2 o roba 2 cartas.", goldyx));
        createCarta(new CartaAccionBasica(59, "Promesa", false, Cristal.BLANCO, "Influencia 2.", "Influencia 4.", goldyx));
        createCarta(new CartaAccionBasica(60, "Amenaza", false, Cristal.ROJO, "Influencia 2.", "Influencia 5. Reputación -1.", goldyx));
        ...
        createCarta(new CartaAccionBasica(64, "Improvisación", false, Cristal.ROJO, "Descarta otra carta de tu mano para obtener Movimiento 3, Influencia 3, Ataque 3 o Bloqueo 3.", "Descarta otra carta de tu mano para obtener Movimiento 5, Influencia 5, Ataque 5 o Bloqueo 5.", goldyx));

        // 28 cartas de Acción Avanzada (juego base)
        createCarta(new CartaAccionAvanzada(65, "Rayo de Fuego", false, Cristal.ROJO, "Gana 1 cristal rojo para tu Inventario.", "Ataque a Distancia de Fuego 3."));
        createCarta(new CartaAccionAvanzada(66, "Rayo de Hielo", false, Cristal.AZUL, "Gana 1 cristal azul para tu Inventario.", "Ataque a Distancia de Hielo 3."));
        createCarta(new CartaAccionAvanzada(67, "Rayo Fulminante", false, Cristal.BLANCO, "Gana 1 cristal blanco para tu Inventario.", "Ataque a Distancia 4."));
        createCarta(new CartaAccionAvanzada(68, "Rayo Devastador", false, Cristal.VERDE, "Gana 1 cristal verde para tu Inventario.", "Ataque de Asedio 3."));
        createCarta(new CartaAccionAvanzada(69, "Furia Sangrienta", false, Cristal.ROJO, "Ataque 2. Puedes recibir 1 Herida para aumentar a Ataque 5.", "Ataque 4. Puedes recibir 1 Herida para aumentar a Ataque 9."));
        createCarta(new CartaAccionAvanzada(70, "Escudo de Hielo", false, Cristal.AZUL, "Bloqueo de Hielo 3.", "Bloqueo de Hielo 3. Reduce en 3 la Armadura de un enemigo bloqueado de esta manera. La Armadura no puede ser reducida por debajo de 1."));
        ...
        createCarta(new CartaAccionAvanzada(72, "Paseo Reparador", false, Cristal.VERDE, "Movimiento 2 y Curación 1. Durante el combate: solo Movimiento 2.", "Movimiento 4 y Curación 2. Durante el combate: solo Movimiento 4."));
        createCarta(new CartaAccionAvanzada(73, "Intimidación", false, Cristal.ROJO, "Influencia 4 o Ataque 3. Reputación -1.", "Influencia 8 o Ataque 7. Reputación -2."));
        createCarta(new CartaAccionAvanzada(74, "Puente Helado", false, Cristal.AZUL, "Movimiento 2. El coste de Movimiento de pantanos se reduce a 1 en este turno.", "Movimiento 4. Puedes moverte a través de lagos. El coste de Movimiento de lagos y pantanos se reduce a 1 en este turno."));
        ...
        createCarta(new CartaAccionAvanzada(76, "Búsqueda del Camino", false, Cristal.VERDE, "Movimiento 2. El coste de Movimiento de todos los terrenos se reduce en 1, hasta un mínimo de 2 en este turno.", "Movimiento 4. El coste de Movimiento de todos los terrenos se reduce a 2 en este turno."));
        ...
        createCarta(new CartaAccionAvanzada(78, "Magia Pura", false, Cristal.AZUL, "Cuando juegues esta carta, paga 1 maná. Si pagas verde, Movimiento 4. Si pagas blanco, Influencia 4. Si pagas azul, Bloqueo 4. Si pagas rojo, Ataque 4.", "Cuando juegues esta carta, paga 1 maná. Si pagas verde, Movimiento 7. Si pagas blanco, Influencia 7. Si pagas azul, Bloqueo 7. Si pagas rojo, Ataque 7."));
        createCarta(new CartaAccionAvanzada(79, "Cuento Heroico", false, Cristal.BLANCO, "Influencia 3. Por cada Unidad que hayas reclutado en este turno, Reputación +1.", "Influencia 6. Por cada Unidad que hayas reclutado en este turno, Fama +1 y Reputación +1."));
        createCarta(new CartaAccionAvanzada(80, "Regeneración", false, Cristal.VERDE, "Curación 1. Prepara 1 Unidad de Nivel I o II que controles.", "Curación 2. Prepara 1 Unidad de Nivel I, II o III que controles."));
        createCarta(new CartaAccionAvanzada(81, "Hacia el Fragor", false, Cristal.ROJO, "Juega esta carta al principio del combate. Todas tus Unidades aumentan sus valores de Ataque y Bloqueo en +2 durante este combate. No puedes asignar daño a tus Unidades en este turno.", "Juega esta carta al principio del combate. Todas tus Unidades aumentan sus valores de Ataque y Bloqueo en +3 durante este combate. No puedes asignar daño a tus Unidades en este turno."));
        ...
        createCarta(new CartaAccionAvanzada(83, "Diplomacia", false, Cristal.BLANCO, "Influencia 2. Puedes usar Influencia como Bloqueo en este turno.", "Influencia 4. Elige Hielo o Fuego. Puedes usar Influencia como Bloqueo del elemento elegido en este turno."));
        createCarta(new CartaAccionAvanzada(84, "Necesitado", false, Cristal.VERDE, "Influencia 3. Gana Influencia, +1 adicional por cada carta de Herida en tu mano o en Unidades que controles.", "Influencia 5. Gana Influencia, +2 adicional por cada carta de Herida en tu mano o en Unidades que controles."));
        ...
        createCarta(new CartaAccionAvanzada(86, "Dominio del Cristal", false, Cristal.AZUL, "Gana 1 cristal para tu Inventario del mismo color que un cristal que ya poseas.", "Al final del turno, cualquier cristal que hayas utilizado en este turno se devuelve a tu inventario."));
        ...
        createCarta(new CartaAccionHechizo(93, "Bola de Fuego", false, Cristal.ROJO, "Ataque a Distancia de Fuego 5.", "Recibe 1 Herida. Ataque de Asedio de Fuego 8.", "Tormenta de Fuego"));
        createCarta(new CartaAccionHechizo(94, "Tormenta de Nieve", false, Cristal.AZUL, "Ataque a Distancia de Hielo 5.", "Recibe 1 Herida. Ataque de Asedio de Hielo 8.","Ventisca"));
        createCarta(new CartaAccionHechizo(95, "Exposición", false, Cristal.BLANCO, "El enemigo objetivo pierde todas las fortificaciones y resistencias durante este combate. Ataque a Distancia 2.", "Los enemigos pierden todas las fortificaciones, o pierden todas las resistencias durante este combate. Ataque a Distancia 3.", "Exposición Masiva"));
        ...
        createCarta(new CartaAccionHechizo(97, "Muro de Llamas", false, Cristal.ROJO, "Ataque de Fuego 5, o Bloqueo de Fuego 7.", "Ataque de Fuego 5, o Bloqueo de Fuego 7. Este Ataque o Bloqueo incrementa en 2 por cada ficha de enemigo a la que te estás enfrentando.", "Ola de Llamas"));
        createCarta(new CartaAccionHechizo(98, "Rayo de Maná", false, Cristal.AZUL, "Cuando juegues esta carta, paga 1 maná. Si es azul, Ataque de Hielo 8. Si es rojo, Ataque de Fuego Frío 7. Si es blanco, Ataque a Distancia de Hielo 6. Si es verde, Ataque de Asedio de Hielo 5.", "Cuando juegues esta carta, paga 1 maná. Si es azul, Ataque de Hielo 11. Si es rojo, Ataque de Fuego Frío 10. Si es blanco, Ataque a Distancia de Hielo 9. Si es verde, Ataque de Asedio de Hielo 8.", "Trueno de Maná"));
        createCarta(new CartaAccionHechizo(99, "Torbellino", false, Cristal.BLANCO, "El enemigo objetivo no ataca durante este combate.", "Juega esta carta solo en la fase de Ataque del combate. Destruye al enemigo objetivo.", "Tornado"));
        createCarta(new CartaAccionHechizo(100, "Viaje Subterráneo", false, Cristal.VERDE, "Muévete hasta 3 espacios revelados en el mapa. No puedes moverte a o a través de pantanos o lagos de este modo, y debes terminar tu movimiento en un espacio seguro. Este movimiento no provoca a los enemigos acechantes.", "Igual que el efecto básico, excepto que debes terminar tu movimiento en un lugar fortificado (o en un espacio ocupado por otro jugador). Esto termina tu movimiento e inicia un asalto (o un ataque a otro jugador). Ignora las fortificaciones del lugar. Si te retiras después del combate, vuelve a tu posición inicial.", "Ataque Subterráneo"));
        createCarta(new CartaAccionHechizo(101, "Escudo Ardiente", false, Cristal.ROJO, "Bloqueo de Fuego 4. Si usas esta carta en un Bloqueo exitoso , puedes usarla también en la fase de Ataque como Ataque de Fuego 4.", "Bloqueo de Fuego 4. Si usas esta carta en un Bloqueo exitoso, destruye al enemigo bloqueado.", "Escudo Explosivo"));
        createCarta(new CartaAccionHechizo(102, "Escalofrío", false, Cristal.AZUL, "El enemigo objetivo no ataca durante este combate. Si tiene Resistencia al Fuego, la pierde para el resto del turno.", "El enemigo objetivo no ataca durante este combate y obtiene Armadura -4 (hasta un mínimo de 1) para el resto del turno.", "Escalofrío Letal"));
        ...
        createCarta(new CartaAccionHechizo(104, "Restaurar", false, Cristal.VERDE, "Curación 3. Si estás en un bosque, Curación 5 en su lugar.", "Curación 3. Si estás en un bosque, Curación 5 en su lugar. Prepara Unidades hasta un valor de 3 niveles. Si estás en un Bosque, Prepara Unidades hasta un valor de 5 niveles en su lugar.", "Renacer"));
        ...
        createCarta(new CartaAccionHechizo(106, "Salto en el Espacio", false, Cristal.AZUL, "En este turno, puedes moverte a espacios y explorar nuevas losetas que estén a 2 espacios de distancia de ti como si estuvieran adyacentes. Ignora cualquier espacio por el que saltes de este modo. Este movimiento no provoca a los enemigos acechantes.", "Al final de tu turno, deja esta carta apartada para el resto de la Ronda. Coloca todas las demás cartas que hayas jugado en este turno (pero no las que hayas descartado o retirado) de nuevo en tu mano. Ignora la parte \"roba cartas nuevas\" del paso final de tu turno. Vuelve a realizar inmediatamente otro turno completo.", "Salto en el Tiempo"));
        createCarta(new CartaAccionHechizo(107, "Llamada a las Armas", false, Cristal.BLANCO, "Puedes usar una aptitud de una Unidad en la oferta de Unidades en este turno, como si fuese una de las reclutadas por ti. No puedes asignar daño a esta Unidad.", "Recluta cualquier Unidad de la oferta de Unidades sin coste. (Si no tienes espacio para añadirla, debes disolver una Unidad primero.)", "Llamada a la Gloria"));
        createCarta(new CartaAccionHechizo(108, "Meditación", false, Cristal.VERDE, "Toma 2 cartas al azar de tu pila de descarte y colócalas en la parte inferior o superior de tu mazo de Gesta. Tu límite de mano aumenta en 2 la próxima vez que robes cartas.", "Igual que el efecto básico, excepto que eliges las cartas en vez de tomarlas al azar.", "Trance"));

        // 12 cartas de Táctica
        createCarta(new CartaTactica(129, "Madrugador", false, TipoTactica.DIA, 1, ""));
        createCarta(new CartaTactica(130, "Rectificar", false, TipoTactica.DIA, 2, "Cuando elijas esta Táctica, descarta hasta 3 cartas (incluyendo Heridas) de tu mano, luego roba la misma cantidad de cartas. Baraja tu pila de descarte junto con tu mazo de Gesta."));
        createCarta(new CartaTactica(131, "Robar Maná", false, TipoTactica.DIA, 3, "Cuando elijas esta Táctica, toma 1 dado de maná de color básico de la Fuente y colócalo sobre esta carta. Puedes usar este maná en uno de tus turnos durante este Día. Si lo haces, relánzalo al final de ese turno y devuélvelo a la Fuente."));
        createCarta(new CartaTactica(132, "Planificar", false, TipoTactica.DIA, 4, "Al final de cada turno, si tienes al menos 2 cartas en tu mano antes de robar, roba 1 carta más que tu límite de mano."));
        createCarta(new CartaTactica(133, "Buen Comienzo", false, TipoTactica.DIA, 5, "Cuando elijas esta Táctica, roba inmediatamente 2 cartas."));
        createCarta(new CartaTactica(134, "El Momento Adecuado", false, TipoTactica.DIA, 6, "Una vez durante este Día, en tu turno, puedes anunciar que realizarás otro turno inmediatamente después de este. Si lo haces, voltea esta carta boca abajo."));
        createCarta(new CartaTactica(135, "Desde la Oscuridad", false, TipoTactica.NOCHE, 1, ""));
        createCarta(new CartaTactica(136, "Larga Noche", false, TipoTactica.NOCHE, 2, "Una vez durante esta Noche, si tu mazo de Gesta está vacío, puedes barajar tu pila de descarte y colocar 3 cartas al azar de vuelta en el mazo de Gesta. Luego, voltea esta carta boca abajo."));
        createCarta(new CartaTactica(137, "Búsqueda de Maná", false, TipoTactica.NOCHE, 3, "Una vez por turno, antes de usar maná de la Fuente, puedes relanzar hasta 2 dados de maná de la Fuente. Cuando escojas los dados para relanzar, debes elegir primero los dados dorados (inactivos) si hay alguno."));
        ...
        createCarta(new CartaTactica(139, "Preparación", false, TipoTactica.NOCHE, 5, "Cuando elijas esta Táctica, busca en tu mazo de Gesta 1 carta que quieras y colócala en tu mano. Luego, baraja el mazo."));
        ...
        createCarta(new CartaAccionAvanzadaEspecial(266, "Poder de los Cristales", false, Cristal.VERDE,  "Gana 1 cristal para tu Inventario de un color básico que aún no tengas.", "Movimiento 4, o Curación 2, o roba dos cartas. Por cada conjunto de 4 cristales de diferentes colores en tu Inventario: Movimiento 2, o Curación 1, o roba una carta.", Cristal.AZUL));
        createCarta(new CartaAccionAvanzadaEspecial(267, "Descarga de Adrenalina", false, Cristal.ROJO, "Por cada una de las primeras 3 Heridas que llevas a la mano en este turno, roba 1 carta.", "Tras tomar la primera Herida a la mano en este turno, retírala y roba 1 carta. Por cada 1 de las 3 Heridas siguientes que tomes, roba 1 carta.", Cristal.VERDE ));
        createCarta(new CartaAccionAvanzadaEspecial(268, "Rayo Explosivo", false, Cristal.BLANCO, "Recibe 1 Herida. Gana 1 cristal blanco y rojo para tu Inventario.", "Ataque a Distancia 3. Por cada enemigo derrotado con este ataque, otro enemigo obtiene Armadura -1 (hasta un mínimo de 1).", Cristal.ROJO));
        createCarta(new CartaAccionAvanzadaEspecial(269, "Mirada Penetrante", false, Cristal.AZUL, "Influencia 3, o el ataque del enemigo objetivo pierde todas sus aptitudes (pero no su color).", "Influencia 5, o el enemigo objetivo no ataca en este turno.", Cristal.BLANCO));

        // 16 cartas del Mazo de Gesta de Wolfhawk (Acción Básica)
        createCarta(new CartaAccionBasica(271, "Rabia", false, Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", wolfhawk));
        createCarta(new CartaAccionBasica(272, "Rabia", false, Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", wolfhawk));
        createCarta(new CartaAccionBasica(273, "Determinación", false, Cristal.AZUL, "Ataque o Bloqueo 2.", "Bloqueo 5.", wolfhawk));
        createCarta(new CartaAccionBasica(274, "Reflejos Instantáneos", false, Cristal.BLANCO, "Movimiento 2, Ataque a Distancia 1, o reduce el ataque de un enemigo en 1.", "Movimiento 4, Ataque a Distancia 3, o reduce el ataque de un enemigo en 2.", wolfhawk));
        createCarta(new CartaAccionBasica(275, "Rapidez", false, Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", wolfhawk));
        createCarta(new CartaAccionBasica(276, "Marcha", false, Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", wolfhawk));
        createCarta(new CartaAccionBasica(277, "Marcha", false, Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", wolfhawk));
        ...
        createCarta(new CartaAccionBasica(279, "Resistencia", false, Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", wolfhawk));
        createCarta(new CartaAccionBasica(280, "Tranquilidad", false, Cristal.VERDE, "Curación 1 o roba 1 carta.", "Curación 2 o roba 2 cartas.", wolfhawk));
        createCarta(new CartaAccionBasica(281, "Promesa", false, Cristal.BLANCO, "Influencia 2.", "Influencia 4.", wolfhawk));
        createCarta(new CartaAccionBasica(282, "Amenaza", false, Cristal.ROJO, "Influencia 2.", "Influencia 5. Reputación -1.", wolfhawk));
        createCarta(new CartaAccionBasica(283, "Cristalización", false, Cristal.AZUL, "Cuando juegues esta carta, paga 1 maná de color básico. Gana 1 cristal de ese color para tu inventario.", "Gana 1 cristal de cualquier color para tu Inventario.", wolfhawk));
        ...
        createCarta(new CartaAccionBasica(286, "Improvisación", false, Cristal.ROJO, "Descarta otra carta de tu mano para obtener Movimiento 3, Influencia 3, Ataque 3 o Bloqueo 3.", "Descarta otra carta de tu mano para obtener Movimiento 5, Influencia 5, Ataque 5 o Bloqueo 5.", wolfhawk));

        // 12 cartas de Acción Avanzada (Legión Perdida)
        createCarta(new CartaAccionAvanzada(287, "Contraataque", false, Cristal.ROJO, "Ataque 2. Gana Ataque 2 adicional por cada enemigo bloqueado en este turno.", "Ataque 4. Gana Ataque 3 adicional por cada enemigo bloqueado en este turno."));
        ...
        createCarta(new CartaAccionAvanzada(290, "Golpe de Escudo", false, Cristal.AZUL, "Bloqueo 3. Cuenta el doble contra un ataque Veloz.", "Bloqueo 5. Cuenta el doble contra un ataque Veloz. El enemigo bloqueado obtiene Armadura -1 por cada punto de bloqueo sobrante (hasta un mínimo de 1)."));
        ...
        createCarta(new CartaAccionAvanzada(292, "Hechizo Forjado", false, Cristal.AZUL, "Gana 1 cristal para tu Inventario del mismo color de 1 de los Hechizos en la oferta de Hechizos.", "Gana 2 cristales para tu Inventario de los mismos colores que 2 Hechizos diferentes en la oferta de Hechizos."));
        createCarta(new CartaAccionAvanzada(293, "Cortesía", false, Cristal.BLANCO, "Ataque 3, o Ataque 2 y Reputación +1 por cada enemigo derrotado por este ataque.", "Ataque 6, o Ataque 4 y Reputación +1 y Fama +1 por cada enemigo derrotado por este ataque."));
        ...
        createCarta(new CartaAccionAvanzada(297, "Fuerza de la Naturaleza", false, Cristal.VERDE, "La Unidad elegida gana Resistencia Física en este combate.", "Ataque de Asedio 3 o Bloqueo 6"));
        ...
        createCarta(new CartaAccionHechizo(299, "Ofrenda", false, Cristal.ROJO, "Gana un cristal rojo para tu Inventario. Puedes descartar hasta 3 cartas que no sean Herida de tu mano. Por cada carta descartada gana un cristal del mismo color que la carta para tu Inventario (si descartas Artefactos, puedes escoger el color).", "Elige verde o blanco, luego elige rojo o azul. Gana Ataque de Asedio 4 (si escogiste verde) o Ataque a Distancia 6 (si escogiste blanco) por cada pareja de cristales de uno de estos dos colores en tu Inventario. Este Ataque es de Fuego (si escogiste rojo) o Hielo (si escogiste azul). Luego, convierte todas las parejas de cristales en maná.", "Sacrificio"));
        createCarta(new CartaAccionHechizo(300, "Forma Nebulosa", false, Cristal.AZUL, "Movimiento 4. El coste de Movimiento de todos los terrenos, incluidos los lagos, es 2. No puedes entrar en colinas y montañas durante el resto de este turno.", "Todas tus Unidades obtienen todas las resistencias. Tu héroe ignora la primera Herida de los enemigos en este turno. Ignora también cualquier efecto adicional de esa Herida.", "Velo Nebuloso"));
        createCarta(new CartaAccionHechizo(301, "Encanto", false, Cristal.BLANCO, "Influencia 4. Si usas esta carta durante la interacción puedes ganar un cristal de cualquier color para tu Inventario o bien obtener un descuento de 3 en el coste de una Unidad.", "El enemigo objetivo no ataca. En la fase de Ataque ganas el mismo Ataque que el del enemigo, incluidos sus elementos (si tuviera alguno), pero ignorando las aptitudes especiales. Con ese Ataque solo puedes hacer objetivo a otros enemigos.", "Posesión"));
        createCarta(new CartaAccionHechizo(302, "Cura", false, Cristal.VERDE, "Curación 2. Roba una carta por cada Herida curada de tu mano en este turno, y prepara las Unidades curadas en este turno.", "Todos los enemigos bloqueados durante la fase de Bloqueo reducen su Armadura a 1.", "Enfermedad"));

        // 16 cartas del Mazo de Gesta de Krang (Acción Básica)
        createCarta(new CartaAccionBasica(337, "Rabia", false, Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", krang));
        createCarta(new CartaAccionBasica(338, "Rabia", false, Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", krang));
        createCarta(new CartaAccionBasica(339, "Determinación", false, Cristal.AZUL, "Ataque o Bloqueo 2.", "Bloqueo 5.", krang));
        createCarta(new CartaAccionBasica(340, "Rapidez", false, Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", krang));
        createCarta(new CartaAccionBasica(341, "Rapidez", false, Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", krang));
        createCarta(new CartaAccionBasica(342, "Cosecha Salvaje", false, Cristal.VERDE, "Movimiento 2. Una vez en este turno, cuando te muevas un espacio, puedes descartar 1 carta para ganar 1 cristal del mismo color. Si descartas 1 Artefacto puedes escoger el color.", "Movimiento 4. Cada vez que te muevas un espacio en este turno, puedes descartar 1 carta para ganar 1 cristal del mismo color. Si descartas 1 Artefacto puedes escoger el color.", krang));
        createCarta(new CartaAccionBasica(343, "Marcha", false, Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", krang));
        createCarta(new CartaAccionBasica(344, "Resistencia", false, Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", krang));
        createCarta(new CartaAccionBasica(345, "Resistencia", false, Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", krang));
        createCarta(new CartaAccionBasica(346, "Tranquilidad", false, Cristal.VERDE, "Curación 1 o roba 1 carta.", "Curación 2 o roba 2 cartas.", krang));
        createCarta(new CartaAccionBasica(347, "Promesa", false, Cristal.BLANCO, "Influencia 2.", "Influencia 4.", krang));
        ...
        createCarta(new CartaAccionBasica(349, "Cristalización", false, Cristal.AZUL, "Cuando juegues esta carta, paga 1 maná de color básico. Gana 1 cristal de ese color para tu inventario.", "Gana 1 cristal de cualquier color para tu Inventario.", krang));
        ...
        createCarta(new CartaAccionBasica(352, "Improvisación", false, Cristal.ROJO, "Descarta otra carta de tu mano para obtener Movimiento 3, Influencia 3, Ataque 3 o Bloqueo 3.", "Descarta otra carta de tu mano para obtener Movimiento 5, Influencia 5, Ataque 5 o Bloqueo 5.", krang));

        // 16 cartas del Mazo de Gesta de Braevalar (Acción Básica)
        createCarta(new CartaAccionBasica(356, "Rabia", false, Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", braevalar));
        createCarta(new CartaAccionBasica(357, "Rabia", false, Cristal.ROJO, "Ataque o Bloqueo 2.", "Ataque 4.", braevalar));
        createCarta(new CartaAccionBasica(358, "Determinación", false, Cristal.AZUL, "Ataque o Bloqueo 2.", "Bloqueo 5.", braevalar));
        createCarta(new CartaAccionBasica(359, "Rapidez", false, Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", braevalar));
        createCarta(new CartaAccionBasica(360, "Rapidez", false, Cristal.BLANCO, "Movimiento 2.", "Ataque a Distancia 3.", braevalar));
        createCarta(new CartaAccionBasica(361, "Marcha", false, Cristal.VERDE, "Movimiento 2.", "Movimiento 4.", braevalar));
        createCarta(new CartaAccionBasica(362, "Unido con la Tierra", false, Cristal.VERDE, "Movimiento 2, Curación 1, o Bloqueo 2.", "Movimiento 4, Curación 2, o Bloqueo igual al coste de Movimiento sin modificar del espacio en el que te encuentras (Montañas 5, Lagos 2). Bloqueo de Fuego durante el Día y Bloqueo de Hielo durante la Noche.", braevalar));
        createCarta(new CartaAccionBasica(363, "Resistencia", false, Cristal.AZUL, "Movimiento 2.", "Movimiento 4.", braevalar));
        createCarta(new CartaAccionBasica(364, "Sendas del Druida", false, Cristal.AZUL, "Movimiento 2. El coste de Movimiento de un espacio se reduce en 1 en este turno, hasta un mínimo de 2.", "Movimiento 4. El coste de Movimiento de un tipo de terreno se reduce en 1 en este turno, hasta un mínimo de 2.", braevalar));
        createCarta(new CartaAccionBasica(365, "Tranquilidad", false, Cristal.VERDE, "Curación 1 o roba 1 carta.", "Curación 2 o roba 2 cartas.", braevalar));
        createCarta(new CartaAccionBasica(366, "Promesa", false, Cristal.BLANCO, "Influencia 2.", "Influencia 4.", braevalar));
        createCarta(new CartaAccionBasica(367, "Amenaza", false, Cristal.ROJO, "Influencia 2.", "Influencia 5. Reputación -1.", braevalar));
        createCarta(new CartaAccionBasica(368, "Cristalización", false, Cristal.AZUL, "Cuando juegues esta carta, paga 1 maná de color básico. Gana 1 cristal de ese color para tu inventario.", "Gana 1 cristal de cualquier color para tu Inventario.", braevalar));
        ...
        createCarta(new CartaAccionBasica(371, "Improvisación", false, Cristal.ROJO, "Descarta otra carta de tu mano para obtener Movimiento 3, Influencia 3, Ataque 3 o Bloqueo 3.", "Descarta otra carta de tu mano para obtener Movimiento 5, Influencia 5, Ataque 5 o Bloqueo 5.", braevalar));
